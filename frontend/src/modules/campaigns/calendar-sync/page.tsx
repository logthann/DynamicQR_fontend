...
import { getIntegrations, startIntegrationConnect } from '@/apis/integrations-api';
...
export default function Page() {
  ...
  const connectMutation = useMutation({
    mutationFn: () => {
      ...
      return startIntegrationConnect({ provider: 'google_calendar', redirectUri });
    },
    onMutate: () => {
      setState('pending');
  ...
  const syncMutation = useMutation({
    mutationFn: () => syncCampaign({ campaignId }),
    onMutate: () => {
      setState('pending');
  ...
  const unlinkMutation = useMutation({
    mutationFn: () => unlinkCampaign({ campaignId }),
    onMutate: () => {
      setState('pending');
