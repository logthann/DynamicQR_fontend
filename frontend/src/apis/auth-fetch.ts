...
export function setAuthContext(context: AuthContext): void {
  ...
  const nextContext: AuthContext = {
    ...
    ...(context.fullName ? { fullName: context.fullName } : {}),
  ...
  if (
    !nextContext.userId &&
    !nextContext.role &&
    !nextContext.displayName &&
    !nextContext.fullName &&
    !nextContext.username &&
    !nextContext.email &&
    !nextContext.companyName
  ) {
...
export function getAuthContext(): AuthContext {
  ...
  const merged: AuthContext = {
    ...
    ...(derived.displayName ? { displayName: derived.displayName } : {}),
    ...(derived.fullName ? { fullName: derived.fullName } : {}),
    ...(derived.username ? { username: derived.username } : {}),
